...
| `profiles.default.storage.s3.access_key` | `${vault.dev.storage.s3.access_key_id || FILE_MCP_S3_ACCESS_KE...` | `CLOUD_DOG__PROFILES__DEFAULT__STORAGE__S3__ACCESS_KEY` | Credential or authentication setting for the related subsystem. |
...
| `profiles.default.storage.webdav.username` | `${vault.dev.storage.webdav.username || FILE_MCP_WEBDAV_USERNA...` | `CLOUD_DOG__PROFILES__DEFAULT__STORAGE__WEBDAV__USERNAME` | Configuration value for profiles default storage webdav username. |
...
| `profiles.default.storage.ftp.username` | `${vault.dev.storage.ftp.username || FILE_MCP_FTP_USERNAME || ''}` | `CLOUD_DOG__PROFILES__DEFAULT__STORAGE__FTP__USERNAME` | Configuration value for profiles default storage ftp username. |
...
| `profiles.default.storage.google_drive.client_id` | `${vault.dev.storage.google_drive.client_id || FILE_MCP_GDRIVE...` | `CLOUD_DOG__PROFILES__DEFAULT__STORAGE__GOOGLE_DRIVE__CLIENT_ID` | Configuration value for profiles default storage google drive client id. |
