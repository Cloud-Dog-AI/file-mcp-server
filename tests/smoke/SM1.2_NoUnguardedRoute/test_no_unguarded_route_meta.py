...
PROBES = [
    ...
    ("GET", "/search",                            "ui"),
    ("GET", "/system/settings",                   "ui"),
    ("GET", "/system/about",                      "ui"),
    ("GET", "/file-browser",                      "ui"),
    ("GET", "/storage-profiles",                  "ui"),
    ("GET", "/audit-log",                         "ui"),
    ("GET", "/developer/api-docs",                "ui"),
    ("GET", "/developer/mcp-console",             "ui"),
    ("GET", "/developer/a2a-console",             "ui"),
    ("GET", "/system/jobs",                       "ui"),
